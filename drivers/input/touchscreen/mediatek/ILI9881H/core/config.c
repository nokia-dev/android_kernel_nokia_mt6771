...
int core_config_get_chip_id(void)
{
	...
	uint32_t RealID = 0, PIDData = 0, OTPIDData = 0;
	...
	ipio_info("PID = 0x%x, Core type = 0x%x, OTP ID = 0x%x\n",
		core_config->chip_pid, core_config->core_type, core_config->chip_otp_id);
