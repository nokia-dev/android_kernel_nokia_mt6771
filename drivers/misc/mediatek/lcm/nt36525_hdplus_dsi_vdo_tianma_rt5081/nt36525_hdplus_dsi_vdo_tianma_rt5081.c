...
static void lcm_init(void)
{
	...
	if (lcm_dsi_mode == CMD_MODE) {
		...
		LCM_LOGI("nt36525----tianma----lcm mode = cmd mode :%d----\n", lcm_dsi_mode);
	} else {
		...
		LCM_LOGI("nt36525----tianma----lcm mode = vdo mode :%d----\n", lcm_dsi_mode);
	}
...
static void lcm_suspend(void)
{
	...
	MDELAY(10);
	pr_debug("[LCM-tianma] %s:nt36525_fhd_dsi_vdo_tianma_rt5081\n", __func__);
	/* SET_RESET_PIN(0); */
}
...
LCM_DRIVER nt36525_hdplus_dsi_vdo_tianma_rt5081_lcm_drv = {
	.name = "nt36525_hdplus_dsi_vdo_tianma_rt5081_drv",
//#endif
