...
struct IMGSENSOR_HW_CFG imgsensor_custom_config[] = {
	{
		...
		IMGSENSOR_I2C_DEV_0,
		{
			...
			{IMGSENSOR_HW_PIN_AVDD,  IMGSENSOR_HW_ID_REGULATOR}, //vcama2
			{IMGSENSOR_HW_PIN_DOVDD, IMGSENSOR_HW_ID_REGULATOR}, //I2C, vcamio
			{IMGSENSOR_HW_PIN_DVDD,  IMGSENSOR_HW_ID_GPIO}, //MCAM_DVDD_1P5_EN, GPIO169
			{IMGSENSOR_HW_PIN_PDN,   IMGSENSOR_HW_ID_GPIO}, //MCAM_AVDD_2P8_EN, GPIO159
	...
	},
	{
		...
		{
			{IMGSENSOR_HW_PIN_MCLK,  IMGSENSOR_HW_ID_MCLK},
			{IMGSENSOR_HW_PIN_AVDD,  IMGSENSOR_HW_ID_GPIO},///OEM
			{IMGSENSOR_HW_PIN_DOVDD, IMGSENSOR_HW_ID_REGULATOR},
			{IMGSENSOR_HW_PIN_DVDD,  IMGSENSOR_HW_ID_REGULATOR},///OEM
			{IMGSENSOR_HW_PIN_PDN,   IMGSENSOR_HW_ID_GPIO}, ///OEM for DVDD Enable
			{IMGSENSOR_HW_PIN_RST,   IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_NONE, IMGSENSOR_HW_ID_NONE},
		},
	},
	{
		...
		{
			{IMGSENSOR_HW_PIN_MCLK,  IMGSENSOR_HW_ID_MCLK},
			{IMGSENSOR_HW_PIN_AVDD,  IMGSENSOR_HW_ID_GPIO}, //SCAM_AVDD_2P85_EN, GPIO166
			{IMGSENSOR_HW_PIN_DOVDD, IMGSENSOR_HW_ID_REGULATOR}, //I2C, vcamio
			{IMGSENSOR_HW_PIN_DVDD,  IMGSENSOR_HW_ID_REGULATOR}, //vcamd 
			{IMGSENSOR_HW_PIN_PDN,   IMGSENSOR_HW_ID_GPIO}, //SCAM_DVDD_1P2_EN, GPIO160
			{IMGSENSOR_HW_PIN_RST,   IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_NONE,  IMGSENSOR_HW_ID_NONE},
		},
	},
