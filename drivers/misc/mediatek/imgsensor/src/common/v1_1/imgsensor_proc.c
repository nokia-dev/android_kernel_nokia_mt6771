...
static int s5k5e9yx_kbuffer_read(struct seq_file *m, void *v)
{
	PK_DBG("s5k5e9yx_kbuffer_read %s\n", fih_s5k5e9yx_kbuffer);
	seq_printf(m, "%s\n", fih_s5k5e9yx_kbuffer);
	return 0;
};

static int s5k5e9yx_lsc_read(struct seq_file *m, void *v)
{
	PK_DBG("s5k5e9yx_lsc_read %s\n", fih_s5k5e9yx_lsc);
	seq_printf(m, "%s\n", fih_s5k5e9yx_lsc);
	return 0;
};

static int s5k5e9yx_wbc_read(struct seq_file *m, void *v)
{
	PK_DBG("s5k5e9yx_wbc_read %s\n", fih_s5k5e9yx_wbc);
	seq_printf(m, "%s\n", fih_s5k5e9yx_wbc);
	return 0;
};
...
static int proc_s5k5e9yx_kbuffer_open(struct inode *inode, struct file *file)
{
	return single_open(file, s5k5e9yx_kbuffer_read, NULL);
};

static int proc_s5k5e9yx_lsc_open(struct inode *inode, struct file *file)
{
	return single_open(file, s5k5e9yx_lsc_read, NULL);
};

static int proc_s5k5e9yx_wbc_open(struct inode *inode, struct file *file)
{
...
static const struct file_operations fcamera_proc_s5k5e9yx_kbuffer = {
	.owner = THIS_MODULE,
	.open = proc_s5k5e9yx_kbuffer_open,
	.read = seq_read,
};

static const struct file_operations fcamera_proc_s5k5e9yx_lsc = {
	.owner = THIS_MODULE,
	.open = proc_s5k5e9yx_lsc_open,
	.read = seq_read,
};

static const struct file_operations fcamera_proc_s5k5e9yx_wbc = {
	.owner = THIS_MODULE,
