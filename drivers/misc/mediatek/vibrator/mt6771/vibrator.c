...
void vibr_Enable_HW(void)
{
	...
	ret = pmic_set_register_value(PMIC_RG_LDO_VIBR_EN, 1);
	if (ret!=0)
		BBOX_VIBRATOR_WRTIE_REGISTER_FAIL
...
void vibr_Disable_HW(void)
{
	...
	ret = pmic_set_register_value(PMIC_RG_LDO_VIBR_EN, 0);
	if (ret!=0)
		BBOX_VIBRATOR_WRTIE_REGISTER_FAIL
}
