...
static uint64_t sigkills = 0; //20160503, OEM, record LMK kill times and system uptime to BBS
...
//20160503, OEM, record LMK kill times and system uptime to BBS +++
...
log_again:
	...
	if (selected) {
		...
		//20151217, OEM, trim lowmemorykiller logs +++
		...
		*/
		sigkills += 1; //20160503, OEM, record LMK kill times and system uptime to BBS
